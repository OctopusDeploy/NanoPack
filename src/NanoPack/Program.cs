...
namespace NanoPack
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var additional =      app.Option("-a | --additional", "Extra options to pass to New-NanoServerImage, for example: --additional \"--Ipv4Address \\\"172.21.22.101\\\"\". Multiple allowed.", CommandOptionType.MultipleValue);
